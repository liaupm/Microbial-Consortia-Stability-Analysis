...
def gro_experiments(gro, rdn_seed, type_exp, circuit, df, n_strains, num_cells, position, k_degA, k_degB, t_deg, frac_surv, ecolis, cont):
    ...
    for repeat in range(10):
        ...
        [direction_exp, direction_exp_output]= gro_writer_paralelo(type_exp, circuit, n_strains, t_deg, k_degA, k_degB, frac_surv, rdn_seed, ecolis, cont)
...
if __name__ == '__main__':
    ...
    k_degradationA = [0.015, 0.1, 0.3]
    k_degradationB = [0.015, 0.1, 0.3]
    replate_frac = [1]
    
    n_pos = 3
    rdn_seed = 1 #Inicializamos la seed
            ...
            for k_degB in k_degradationB:
                ...
                for t_deg in t_degradation:
                    ...
                    for frac_surv in replate_frac:
                        ...
                        pool.apply_async(gro_experiments, args = (gro, rdn_seed, type_exp, circuit, df, n_strains, num_cells, position, k_degA, k_degB, t_deg, frac_surv, ecolis, cont)) 
