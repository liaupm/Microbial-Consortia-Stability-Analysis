...
def ann(cleanattributes, onehot, df, n_epochs, learning_rate, batch_size, n_neurons_per_hlayer, dropout, act_fun, my_regularizer, my_initializer, my_optimizer, norm, n):
    ...
    with open( 'C:/TFM/ann/Binary/data_ann_' + str(n) + '.pickle', 'wb') as handle:
...
if __name__ == '__main__':
    ...
    onehot = 'C:/TFM/ann/data_replating_continuous_2labels.csv'
    ...
    batch = [512, 1024] #, 5018]
    n_neurons_per_hlayer = [150, 100, 75, 50, 25]
    dr = [0.1]
    act = ['relu', 'elu', 'tanh']
